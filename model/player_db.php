...
function add_player($player_ID, $team_ID, $player_Pseudo, $player_Job,
        $player_Title, $player_FC) {
    global $db;
    $query = 'INSERT INTO player
                 (playerID, teamID, playerPseudo, playerJob,
                 playerTitle, playerFC)
              VALUES
                 (:player_ID, :team_ID, :player_Pseudo, :player_Job, :player_Title,
                  :player_FC)';
    try {
        $statement = $db->prepare($query);
        $statement->bindValue(':player_ID', $player_ID);
